    ...
    <HomeTemplate title="Profile" activeLink="Profile">
      <div className="flex h-full w-full">
        <form className="flex flex-col m-0 lg:mx-auto my-auto p-6 lg:p-12 w-full lg:w-6/12 space-y-6 lg:space-y-4 border border-purple-800 rounded-md">
          {success && (
            <h2 className="mx-auto text-base text-green-600">
          ...
          <div className="flex flex-col justify-end space-y-4">
            ...
            <button
              type="button"
              disabled={__disabled}
              className={`form_submitter text-white rounded-lg w-8/12 h-8 ml-auto hover:bg-purple-400 focus:outline-none ${
                __disabled
          ...
          <div className="flex flex-col justify-end space-y-4">
            <div className="flex flex-row justify-between space-x-2 lg:space-x-4">
              <label
                htmlFor="news_preference"
                className="text-purple-800 w-4/12"
              >
                News Preference
              </label>
            ...
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                saveToLocalStorage("newsPreference", newsPreference);
              }}
            >
